...
GAMEPAD_DEBUG_ALL_BUTTONS = True
...
# Max joint velocities (rad/s) at full stick deflection; scaled by |axis| for smoother feel.
...
class GamepadTeleop:
    ...
    def _apply_joint_velocity(self, joints: list[float], joint_name: str, axis_value: float, dt: float) -> None:
        ...
        gain = 0.4 + 0.6 * abs(axis_value)  # soft ramp so small deflection moves slowly
